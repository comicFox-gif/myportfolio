    ...
    <div className="web3-container">
      ...
      <footer className="footer">
        ...
        <div className="socials">
          <a href="https://x.com/perrywire_" target="_blank" rel="noopener noreferrer">X (Twitter)</a> • <span>GitHub</span> • <a href="https://discord.com/app" target="_blank" rel="noopener noreferrer">Discord (@comicfox.sol)</a>
        </div>
      </footer>
    </div>
  );
